...
from Py_iarduino_I2C_Relay import *										# Подключаем библиотеку для работы с реле
relay = Py_iarduino_I2C_Relay()                                         # Объявляем объект relay для работы с функциями и методами модуля Py_iarduino_I2C_Relay.
