...
from Py_iarduino_I2C_Relay import *										# Подключаем библиотеку (модуль) для работы с реле
relay = Py_iarduino_I2C_Relay()                                         # Объявляем объект relay для работы с функциями и методами библиотеки iarduino_I2C_Relay, указывая адрес модуля на шине I2C.
