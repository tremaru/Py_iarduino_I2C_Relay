#!/usr/bin/python3
# Данный пример демонстрирует защиту от зависания шины или Raspberry 
                                        #
...
pwrfet = pyiArduinoI2Crelay(0x09)       # Объявляем объект pwrfet для работы с функциями и методами библиотеки iarduino_I2C_Relay, указывая адрес модуля на шине I2C.
